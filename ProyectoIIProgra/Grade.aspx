<%@ Page Title="Notas" Language="C#" MasterPageFile="~/MenuPrincipal.Master" AutoEventWireup="true" CodeBehind="Grade.aspx.cs" Inherits="ProyectoIIProgra.Grade" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="miDiv">
        <h1 class="miTitulo">Notas</h1>
    </div>

    <div class="miDiv">
        <asp:GridView ID="GridGrade" runat="server" CssClass="miGrid">
        </asp:GridView>
    </div>

    <div class="miDiv">
        <div class="texto-con-input">
            <p class="miTexto">Código de nota:</p>
            <asp:TextBox ID="TGradeId" runat="server"></asp:TextBox>
        </div>
        <div class="texto-con-input">
        ...
        <div class="texto-con-input">
            <p class="miTexto">Comentarios:</p>
            <asp:TextBox ID="TComment" runat="server"></asp:TextBox>
        </div>
    </div>
